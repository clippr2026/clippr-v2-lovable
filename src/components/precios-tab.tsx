    ...
    <div className="grid md:grid-cols-2 gap-4">
      ...
      <div className="space-y-3">
        ...
        {finalServiceCats.map((catName) => {
          ...
          return (
            <div key={catName} className="rounded-[24px] border border-white/[0.08] bg-white/[0.03] cash-panel-glow overflow-hidden shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
