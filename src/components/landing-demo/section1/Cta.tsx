...
// página. <Link>, no <a href>: navegación del lado del cliente, sin la
// recarga completa que causaba el parpadeo/salto al tocar en Safari iOS
// (ver el mismo comentario, más largo, en section1/Header.tsx).
