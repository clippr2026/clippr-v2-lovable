...
function ProfesionalesTab({ businessId, userEmail }: { businessId: string | null; userEmail: string | null }) {
  return (
    <div className="liquidaciones-premium animate-fade-up">
      <style>{`
        .liquidaciones-premium,
        .liquidaciones-premium * {
        ...
        /* Pantalla más compacta: menos alto, más contenido visible sin scroll general */
        .liquidaciones-premium .liquidaciones-shell {
          max-height: calc(100vh - 250px);
          overflow: hidden;
        }

        .liquidaciones-premium .liquidaciones-inner {
        ...
        /* Compactar cards internas del módulo original */
        .liquidaciones-premium .liquidaciones-inner > div > div,
        .liquidaciones-premium .liquidaciones-inner section,
        .liquidaciones-premium .liquidaciones-inner [class*="rounded-3xl"] {
          margin-top: .7rem !important;
          margin-bottom: .7rem !important;
        }

        .liquidaciones-premium .liquidaciones-inner [class*="p-6"] {
          padding: 1rem !important;
        }

        .liquidaciones-premium .liquidaciones-inner [class*="py-6"] {
          padding-top: .9rem !important;
          padding-bottom: .9rem !important;
        }

        .liquidaciones-premium .liquidaciones-inner [class*="py-5"] {
          padding-top: .8rem !important;
          padding-bottom: .8rem !important;
        }

        .liquidaciones-premium .liquidaciones-inner [class*="gap-4"] {
          gap: .7rem !important;
        }

        .liquidaciones-premium .liquidaciones-inner [class*="gap-5"] {
          gap: .8rem !important;
        }
        ...
        .liquidaciones-premium [class*="grid-cols-3"] > div:nth-child(1) {
          ...
          background: linear-gradient(135deg, rgba(167,139,250,.070), rgba(255,255,255,.018)) !important;
          box-shadow: 0 0 26px rgba(167,139,250,.10), inset 0 1px 0 rgba(255,255,255,.055) !important;
        }
        ...
        .liquidaciones-premium [class*="grid-cols-3"] > div:nth-child(2) {
          ...
          background: linear-gradient(135deg, rgba(34,197,94,.055), rgba(255,255,255,.018)) !important;
          box-shadow: 0 0 24px rgba(34,197,94,.07), inset 0 1px 0 rgba(255,255,255,.055) !important;
        }
        ...
        .liquidaciones-premium [class*="grid-cols-3"] > div:nth-child(3) {
          ...
          background: linear-gradient(135deg, rgba(251,113,133,.060), rgba(255,255,255,.018)) !important;
          box-shadow: 0 0 24px rgba(251,113,133,.08), inset 0 1px 0 rgba(255,255,255,.055) !important;
        }
        ...
        /* Todos los botones neutrales por defecto: fecha, producción e historial no verdes */
        ...
        /* Solo si el grupo tiene 3 botones, el último es Pagar comisión */
        .liquidaciones-premium div:has(> button:nth-child(3)) > button:last-child:not(:disabled) {
          border-color: rgba(34,197,94,.24) !important;
          background: linear-gradient(135deg, rgba(34,197,94,.16), rgba(22,163,74,.24)) !important;
          color: #BBF7D0 !important;
          box-shadow: 0 0 18px rgba(34,197,94,.16), inset 0 1px 0 rgba(255,255,255,.08) !important;
        }
        .liquidaciones-premium div:has(> button:nth-child(3)) > button:last-child:not(:disabled):hover {
          background: linear-gradient(135deg, rgba(34,197,94,.22), rgba(22,163,74,.32)) !important;
          color: #FFFFFF !important;
          box-shadow: 0 0 28px rgba(34,197,94,.22), inset 0 1px 0 rgba(255,255,255,.10) !important;
        }
      `}</style>

      <div className="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,1fr)]">
        <section className="liquidaciones-shell overflow-hidden rounded-3xl border border-white/[0.085] bg-[linear-gradient(180deg,rgba(12,16,30,0.95),rgba(5,7,16,0.98))] shadow-[0_24px_85px_-50px_rgba(139,92,246,0.42)]">
          <div className="border-b border-white/[0.065] px-5 py-4">
            <div className="flex items-center gap-4">
              <div className="grid size-11 place-items-center rounded-2xl bg-violet-500/12 text-violet-200 ring-1 ring-violet-300/18"><Wallet className="size-5" /></div>
              <div>
                <div className="text-lg font-bold text-white">Liquidaciones</div>
                <div className="mt-0.5 text-xs text-white/48">Comisiones, pagos e historial por profesional.</div>
              </div>
            </div>
          </div>
          <div className="liquidaciones-inner p-4 [&_button]:transition-all [&_button]:duration-200 [&_.glass]:border-white/[0.085] [&_.glass]:bg-white/[0.025] [&_.glass]:backdrop-blur-xl">
