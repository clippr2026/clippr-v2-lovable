...
function ClientsPage() {
  ...
  return (
    <AppShell>
      <Topbar title="Clientes" subtitle="Cartera, Segmentación Y Reconquista" action={<button onClick={() => setNewClientOpen(true)} className="h-10 px-4 rounded-xl text-white font-medium text-sm flex items-center gap-2 hover:brightness-110 transition" style={{ background: "linear-gradient(135deg, oklch(0.65 0.24 255), oklch(0.65 0.28 305))" }}><Plus className="h-4 w-4" />Nuevo cliente</button>} />
